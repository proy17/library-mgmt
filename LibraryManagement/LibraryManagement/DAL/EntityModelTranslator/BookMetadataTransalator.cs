            ...
            var MetaData = new BookMetadataModel
               {
                   ...
                   Language = bookMetadataEntity.Language,
                   NoOfPages = bookMetadataEntity.NoOfPages,
                   Publisher = bookMetadataEntity.Publisher,
                   BookVersion = bookMetadataEntity.BookVersion
               };
            return MetaData;
            ...
            var bookMetaData = new BookMetadataEntity
                {
                    ...
                    NoOfPages = bookMetadataModel.NoOfPages,
